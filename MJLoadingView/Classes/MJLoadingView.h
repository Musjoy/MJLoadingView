...
#define LOADING_IMAGE_NAME_PREFIX @"img_loading_type_"
#endif
#ifndef LOADING_IMAGE_DURATION
...
@property (nonatomic, assign, readonly) IBInspectable int loadingType;              ///< loading类型<0-默认loading 1-动画loading>
